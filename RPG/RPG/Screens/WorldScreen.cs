    ...
    public class WorldScreen : GameScreen
    {
        ...
        public override void HandleInput(GameTime gameTime, InputManager input)
        {
            ...
            if(input.Direction.X < 0)
            {
                ...
                canMove = CollisionCheck(player, Direction);
        ...
        {
            int targetX = p.PositionX + (int)direction.X;
            int targetY = p.PositionY + (int)direction.Y;
            ...
            {
                return !Array.Exists(collions, element => element == tileFacing);
            }
        }
